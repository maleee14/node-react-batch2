...
CREATE TABLE `blog_posts` (
  ...
  KEY `fk_blog_posts_users_idx` (`author_id`),
  CONSTRAINT `fk_blog_posts_users` FOREIGN KEY (`author_id`) REFERENCES `users` (`id`)
...
CREATE TABLE `post_categories` (
  ...
  KEY `fk_blog_posts_has_categories_categories1_idx` (`categories_id`),
  KEY `fk_blog_posts_has_categories_blog_posts1_idx` (`posts_id`),
  CONSTRAINT `fk_blog_posts_has_categories_blog_posts1` FOREIGN KEY (`posts_id`) REFERENCES `blog_posts` (`id`),
  CONSTRAINT `fk_blog_posts_has_categories_categories1` FOREIGN KEY (`categories_id`) REFERENCES `categories` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-10-13 14:14:02
